  ...
  return (
    ...
    >
      ...
      <div className="mb-16 text-center">
        <h2 className="text-4xl font-bold text-white">EDUCATION / Traning</h2>
        ...
        <p className="mt-4 text-lg font-semibold text-gray-400 max-w-[600px] block m-auto">
          My educational journey reflects a strong foundation of learning,
          continuous growth, and academic development. Below are the details of
          ...
          >
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                {/* School Logo/Image */}
                <div className="w-24 h-20 overflow-hidden bg-white rounded-md">
                  <Image
                    src={edu.img}
                    alt={edu.school}
